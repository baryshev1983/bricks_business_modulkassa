# Bricks.Business.ModulKassa

Пакет включает классы, описывающие параметры для формирования чека согласно 54-ФЗ с использованием [протокола МодульКасса][]. Данные классы реализуют интерфейс, позволяющий сгенерировать JSON-строку на их основе.
...
[протокола МодульКасса]: https://support.modulkassa.ru/help/dlya-razrabotchikov.php
[composer.json]: ./composer.json
[Composer]: http://getcomposer.org/
[исходные коды]: https://github.com/Bashka/bricks_business_modulkassa/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_business_modulkassa/issues
